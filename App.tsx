...
const App: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-dvh bg-black overflow-hidden flex flex-col">
      {/* Header / HUD */}
      <header className="absolute top-0 left-0 w-full p-4 z-20 flex justify-between items-center pointer-events-none bg-gradient-to-b from-black/80 to-transparent">
        ...
        <div className="text-green-800 text-[10px] md:text-xs flex gap-2 md:gap-4 font-mono">
          <span className="hidden sm:inline">SYS.STATUS: ONLINE</span>
          <span className="hidden sm:inline">CAM.FEED: ACTIVE</span>
      ...
      <main className="flex-grow relative z-10">
        <AsciiCanvas options={options} setOptions={setOptions} onCapture={handleCapture} />
      </main>
